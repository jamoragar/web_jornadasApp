			...
			return (
				<BrowserRouter>
					...
					<Switch>
						...
						<Route
							exact
							path="/Dashboard/:uid/createUsers"
							component={() =>
								userData === "Error" ? (
									<Redirect to="/not-found" />
								) : (
